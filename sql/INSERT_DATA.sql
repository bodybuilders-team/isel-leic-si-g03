...
VALUES ('André Páscoa', '962249051', '123456789',
        'Rua Padre Santos Vieira nº1, Lisboa, Portugal', true);
INSERT INTO private_clients (id, citizen_card_number)
VALUES (1, '123456789123');

INSERT INTO clients(name, phone_number, nif, address, active)
VALUES ('BE Fit', '1234', '123456789',
        'Rua Padre Santos Vieira nº1, Lisboa, Portugal', true);
...
INSERT INTO vehicles (gps_device_id, client_id, license_plate, num_alarms)
VALUES (2, 1, '88-66-33', 0);

INSERT INTO vehicles (gps_device_id, client_id, license_plate, num_alarms)
VALUES (3, 2, '33-44-55', 0);

INSERT INTO drivers
VALUES (1, 'Sonic', '962249051');
INSERT INTO drivers
VALUES (2, 'Tails', '333444555');
INSERT INTO drivers
VALUES (3, 'Eggman', '542341141');
...
INSERT INTO green_zones (vehicle_id, center_location, radius)
VALUES (1, point(39.511, -9.0100229), 5);

INSERT INTO green_zones (vehicle_id, center_location, radius)
VALUES (2, point(28.6556752, -9.0100229), 10);

INSERT INTO green_zones (vehicle_id, center_location, radius)
VALUES (3, point(18.6556752, -9.0100229), 15);

INSERT INTO unprocessed_gps_data (device_id, timestamp, location)
VALUES (1, '2022-04-12 04:05:06 UTC+1', point(18, 9));

INSERT INTO unprocessed_gps_data (device_id, timestamp, location)
VALUES (1, '2020-04-12 04:05:06 PST', point(18, 9));

INSERT INTO unprocessed_gps_data (device_id, timestamp, location)
VALUES (3, '2020-04-12 04:05:06 UTC+0', point(18, 9));
